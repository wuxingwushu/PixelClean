...
namespace PhysicsBlock
{
	...
	void PhysicsDemo7(PhysicsWorld **myPhysicsWorld, Camera *mCamera)
	{
		...
		*myPhysicsWorld = new PhysicsBlock::PhysicsWorld({0.0, -9.8}, false);
		...
		PhysicsBlock::PhysicsJunctionP *PhysicsJunctionP1 = new PhysicsBlock::PhysicsJunctionP(PhysicsParticle1, {0, 1});
		(*myPhysicsWorld)->AddObject(PhysicsJunctionP1);
		PhysicsBlock::PhysicsJunctionPP *PhysicsJunctionP2 = new PhysicsBlock::PhysicsJunctionPP(PhysicsParticle1, PhysicsParticle2);
		(*myPhysicsWorld)->AddObject(PhysicsJunctionP2);

		PhysicsParticle1 = new PhysicsBlock::PhysicsParticle({6, -4}, 10);
		(*myPhysicsWorld)->AddObject(PhysicsParticle1);
		PhysicsJunctionP1 = new PhysicsBlock::PhysicsJunctionP(PhysicsParticle1, {6, 0});
		(*myPhysicsWorld)->AddObject(PhysicsJunctionP1);
		...
		PhysicsBlock::PhysicsJunctionS *PhysicsJunction3 = new PhysicsBlock::PhysicsJunctionS(PhysicsShape2, {-0.75, 0.75}, {0, PhysicsShape2->pos.y});
